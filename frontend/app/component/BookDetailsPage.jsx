            ...
            <div className="lg:col-span-6 lg:col-start-7 flex flex-col pt-4">
              ...
              <div className="flex flex-wrap items-center gap-4 mb-8">
                ...
                <button 
                  ...
                  className="flex items-center gap-2 bg-[#FDFBF7] border border-[#8d705b] hover:bg-[#E5DFD5] text-[#8d705b] font-bold rounded-full px-6 h-12 transition-colors ml-auto sm:ml-0"
                >
