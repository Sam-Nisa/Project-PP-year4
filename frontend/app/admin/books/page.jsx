        ...
        <div className="p-6 text-center">
          ...
          >
            ...
            <path
              ...
              strokeWidth="2"
              d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.39 17c-.77 1.333.192 3 1.732 3z"
            ></path>
          </svg>
...
export default function BooksPage() {
  ...
  const handleAddBook = async () => {
    ...
    if (!newBook.genre_id) newErrors.genre_id = "Genre is required.";
    if (!newBook.price) newErrors.price = "Price is required.";

    // If there are errors, setErrors and stop
  ...
  const handleDeleteInitiate = async (book) => {
